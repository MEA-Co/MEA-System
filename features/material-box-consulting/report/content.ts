...
export function createMaterialBoxReport(
  ...
  return {
    careerIdentity: memory.careerIdentity,
    keyword: memory.keyword,
    majors: memory.majorPreferences.map((preference) => preference.major),
    sections: [
      {
        number: '01',
        eyebrow: 'CAREER IDENTITY',
        title: '궁극적으로 그리고 있는 진로',
        content: memory.careerIdentity,
      },
      {
        number: '02',
        eyebrow: 'CORE VALUE',
        title: '해결하고 싶은 문제와 핵심 가치',
        content: memory.coreValue,
      },
      {
        number: '03',
        eyebrow: 'FIELD COMPETENCY',
        title: '분야에서 발휘할 강점과 역량',
        content: memory.fieldStrength,
      },
      {
        number: '04',
        eyebrow: 'PERSONAL POTENTIAL',
        title: '나다운 습관과 잠재 역량',
        content: memory.personalStrength,
      },
    ],
    consultantSummary: `‘${memory.keyword}’에 대한 관심을 ‘${memory.careerIdentity}’라는 구체적인 진로 방향으로 발전시켰습니다. 앞으로 교과 탐구와 비교과 활동에서 동일한 문제의식을 일관되게 드러내고, 학업 역량과 개인적인 장점을 실제 행동의 근거로 연결하면 자신만의 성장 서사가 더욱 선명해질 것입니다.`,
    nextSteps: [
      {
        number: '1',
        title: '탐구 질문 만들기',
