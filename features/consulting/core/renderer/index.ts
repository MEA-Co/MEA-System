...
} from '@/features/consulting/core/renderer/types';

export * from '@/features/consulting/core/renderer/protocol';
export type * from '@/features/consulting/core/renderer/types';

export function createConsultingRenderer<Environment, Output>(
  entries: Readonly<
    Record<string, ConsultingRendererEntry<Environment, Output>>
  >,
): ConsultingRenderer<Environment, Output> {
