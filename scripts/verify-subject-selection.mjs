...
test('문과 Core와 Sub core는 계열 안에서도 학과별 기초와 방향을 구분한다', () => {
  const policies = [
    ...
    [
      '심리학과',
      ['사회와 문화', '확률과 통계'],
      ['인간과 심리', '실용 통계', '현대사회와 윤리'],
    ],
    [
      '상담심리학과',
      ['사회와 문화', '확률과 통계'],
      ['인간과 심리', '실용 통계', '사회문제 탐구', '현대사회와 윤리'],
    ],
    [
      '미디어학과',
      ['사회와 문화'],
      ['매체 의사소통', '독서 토론과 글쓰기', '사회문제 탐구', '현대사회와 윤리'],
    ],
    [
      '광고홍보학과',
      ['사회와 문화'],
  ...
  assert.deepEqual(findPriorityProfile('철학과').profile.core, ['윤리와 사상', '현대사회와 윤리']);
});
