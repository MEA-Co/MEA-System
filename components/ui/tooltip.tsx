  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        ...
        >
          {children}
          <TooltipPrimitive.Arrow className="z-50 m-0 size-2.5 rotate-45 rounded-[2px] bg-inherit data-[side=bottom]:-top-1.25 data-[side=inline-end]:-left-1.25 data-[side=inline-start]:-right-1.25 data-[side=left]:-right-1.25 data-[side=right]:-left-1.25 data-[side=top]:-bottom-1.25" />
        </TooltipPrimitive.Popup>
      </TooltipPrimitive.Positioner>
    </TooltipPrimitive.Portal>
  );
