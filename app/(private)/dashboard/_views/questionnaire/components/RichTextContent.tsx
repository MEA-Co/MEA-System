...
export const richTextClasses = `${styles.content} whitespace-pre-wrap break-words [&_p]:min-h-[1.5em] [&_ul]:list-disc [&_ul]:pl-6 [&_li]:pl-1 [&_mark]:rounded-sm [&_mark]:bg-yellow-200 [&_mark]:px-0.5 [&_mark]:text-inherit dark:[&_mark]:bg-yellow-400/35`;
