...
import { ConsultingResultCard } from '@/app/(private)/consulting/_components/ConsultingResultCard';
...
} from '@/app/(private)/consulting/demo/_screens/data';
