          ...
          segments: [
            {
              text: showExampleReports
                ? '좋습니다! 지금까지 입력한 내용과 전공별 탐구 대화, 대화에서 정리된 탐구 목표와 특성을 위의 재료함 리포트에 담았고, 결과를 더 확장하는 방식은 완성형 예시 리포트로 함께 보여드렸습니다.'
                : '좋습니다! 전공별 탐구 대화와 그 대화에서 정리된 관심 키워드, 탐구 목표, 가치관과 역량을 나의 재료함 리포트로 정리했습니다.',
            },
          ],
        }}
      >
