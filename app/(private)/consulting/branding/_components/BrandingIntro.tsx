...
const scenes: readonly Scene[] = [
  ...
  },
  {
    ...
    message: {
      segments: [
        {
          text: '예전에는, 난이도 있는 주제를 찾아내고 이해하는 것 자체가 어려운 일이었고, 그래서 그 주제로 탐구를 진행하는 것이 곧 우수한 학생이 되는 방법이었습니다.',
        },
      ],
    },
  },
  {
    ...
    message: {
      segments: [
        {
          text: '하지만 지금은 누구나 AI에게 그런 주제들을 받아볼 수 있고, AI가 그 내용을 쉽게 풀어서 설명해주기까지 합니다.',
        },
      ],
    },
  },
  {
    ...
    message: {
      segments: [
        {
          text: '지금 우리에게 중요한 것은, 적재적소에 AI를 활용하여 깊이와 난이도를 유지하면서도 ',
        },
